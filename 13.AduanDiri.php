            ...
            <!-- Aduan -->
                ...
                <?php 
                  foreach ($datas1 as $data) :
                    ...
                    if($_SESSION['IDU']!=$Pengadaan['ID_User']){
                      $cek='none';
                      $jumlahaduankosong++;
                    }else{
                      $cek='block';
                ...
                ?>
                <div class="card mr-4" style="width: 18rem; margin-bottom:25px; display:<?php echo $cek;?>;">
                        ...
                        <p class="card-text">
                          ...
                          <div style="display:flex; justify-content:space-around;">
                            <form action="9.DetilAduan.php" method="post">
                              <button type="submit" value="<?php echo $data['ID_Pengadaan']; ?>" name="IDP" class="btn btn-success">Lihat</button>
                            </form>
                            <form action="14.HapusAduan.php" method="post">
                              <button type="submit" value="<?php echo $data['ID_Pengadaan']; ?>" name="IDP" class="btn btn-danger" style="display:<?php if($status=='Diterima'){ echo 'none'; } ?>;">Hapus</button>
                            </form>
                          </div>
                      </div>
                </div>
                  ...
                  <img src=<?php echo $data['DokumentasiBukti'];?> class="card-img-top" style="width: 100%; height: 190px;" alt="...">
                      <div class="card-body">
                        ...
                        <p class="card-text">
                          ...
                          <div style="display:flex; justify-content:space-around;">
                            <form action="9.DetilAduan.php" method="post">
                              <button type="submit" value="<?php echo $data['ID_Perbaikan']; ?>" name="IDP" class="btn btn-success">Lihat</button>
                            </form>
                            <form action="14.HapusAduan.php" method="post">
                              <button type="submit" value="<?php echo $data['ID_Perbaikan']; ?>" name="IDP" class="btn btn-danger" style="display:<?php if($status=='Diterima'){ echo 'none'; } ?>;">Hapus</button>
                            </form>
                          </div>
                      </div>
                </div>
              <?php endforeach; ?>
              <h5 style="margin-left:330px; display:<?php if($jumlahaduankosong!=$jumlahaduanyangada){ echo 'none'; } ?>;">Tidak Ada Aduan yang Anda Lakukan</h5>
