...
$IDA=$_SESSION['IDA'];
$kabupatenadmin=mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM kabupaten WHERE ID_Kabupaten IN (SELECT ID_Kabupaten_Asal FROM adminkabupaten WHERE ID_Admin='$IDA')"));
$_SESSION['kabupatenadmin']=$kabupatenadmin['Nama_kabupaten'];
...
<html lang="en">
  <head>
    ...
    <title>BerandaAdminKecamatan</title>
  </head>
  <body>
    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5" style="position:fixed; margin-top:-10px;">
              ...
              <li class="nav-item">
                <a class="nav-link text-white" href="18.Wisata_Admin_Kab.php"><i class="fas fa-bus mr-2"></i>Wisata</a><hr class="bg-secondary">
              </li>
              <li>
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <div class="row text-dark" style="margin-left:1px;">
              ...
              foreach ($datas1 as $data) :
                ...
                if($status=="V" || $status=="VI" || $status=="VII"){
                  $status="Diterima";
