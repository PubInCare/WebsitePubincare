...
$IDA=$_SESSION['IDA'];
$camatadmin=mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM kecamatan WHERE ID_Kecamatan IN (SELECT ID_Kecamatan_Asal FROM adminkecamatan WHERE ID_Admin='$IDA')"));
$_SESSION['camatadmin']=$camatadmin['Nama_Kecamatan'];
    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
            <ul class="nav flex-column ml-3 mb-5" style="position:fixed; margin-top:-10px;">
              ...
              <li class="nav-item">
                <a class="nav-link text-white" href="18.Wisata_Admin_Camat.php"><i class="fas fa-bus mr-2"></i>Wisata</a><hr class="bg-secondary">
              </li>
              <li>
