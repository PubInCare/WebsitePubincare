    ...
    <div class="row no-gutters mt-5">
      <div class="col-md-2 bg-dark mt-2 pr-3 pt-4">
        ...
        <div class="col-md-10 p-5 pt-2">
            ...
            <div class="container">
              <h2 class="alert alert-warning text-center">FORM PENGADUAN PENGADAAN</h2>
              <?php 
                if(isset($_GET['error'])){
                  echo 'Waring : '.$_GET['error'];
                }
              ?>
              <form action="7.FormPengadaanAct.php" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                  ...
                  <div class="form-group">
                    <label>Upload Dokumentasi Fasilitas/Lokasi Pengadaan</label>
                  ...
                  <div class="ajukan" onclick="document.getElementById('id01').style.display='block'">Ajukan</div>
                    <div id="id01" class="modal">
                      <div class="modal-content"> 
                        <h1 style="po">Aduan Pengadaan</h1>
