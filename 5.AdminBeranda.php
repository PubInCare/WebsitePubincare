...
$IDA=$_SESSION['IDA'];
$desaadmin=mysqli_fetch_assoc(mysqli_query($conn, "SELECT * FROM desa WHERE ID_Desa IN (SELECT ID_Desa_Asal FROM admindesa WHERE ID_Admin='$IDA')"));
$_SESSION['desaadmin']=$desaadmin['Nama_Desa'];
